...
<script type="text/javascript">
	$(function() {
		...
		$("button").click(function() {
			$.each($(".adpic"), function(i, n) {
				$(n).animate({
					"left" : parseInt($(n).css("left")) - 400 + "px"
				}, 1000, function() {
					//当动画执行完成后执行的功能
					if (i == 0) {
						var $newimg = $(n).clone();
...
<body>
	<button>按钮</button>
	<div id="addiv"
		style="width: 400px;height: 200px;border: 1px solid black;position: absolute;overflow: hidden;">
		<c:forEach items="${list }" var="pic">
			<img class="adpic" src="${pic.path }" width="400" height="200"
